...
const BuilderShow = forwardRef((props, ref) => {
                    ...
                    <div className="container-fluid">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row">
                                ...
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput16" className="form-label">Coporate Office Address City<span className="text-danger"></span></label>
                                    <input type="text" name='coporate_officeaddress_city' className="form-control" id="exampleFormControlInput16" placeholder="" />
                                </div>
                                <div className="col-xl-6 mb-3">
                                    <label htmlFor="exampleFormControlInput17" className="form-label">Coporate Office Address Zipcode<span className="text-danger"></span></label>
                                ...
                                <div className="col-xl-12 mb-3">
                                    <label className="form-label">Coporate Office Address 1 <span className="text-danger"></span></label>
                                    <textarea rows="2" name='coporate_officeaddress_1' className="form-control"></textarea>
                                </div>
                                <div className="col-xl-12 mb-3">
                                    <label className="form-label">Coporate Office Address 2 <span className="text-danger"></span></label>
                                    <textarea rows="2" name='coporate_officeaddress_2' className="form-control"></textarea>
                                </div>
                                <div className="col-xl-12 mb-3">
                                    <label className="form-label">Coporate Office Address Lat<span className="text-danger"></span></label>
                                    <textarea rows="2" name='coporate_officeaddress_lat' className="form-control"></textarea>
                                </div>
                                <div className="col-xl-12 mb-3">
                                    <label className="form-label">Coporate Office Address Lngtd<span className="text-danger"></span></label>
