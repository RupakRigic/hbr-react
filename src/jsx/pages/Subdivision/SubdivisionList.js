                      ...
                      >
                        <thead>
                          ...
                          <th>
                            ...
                            {columns.map((column) => (
                              <th style={{ textAlign: "center", cursor: "pointer" }} key={column.id} onClick={(e) => (column.id == "action" || column.id == "location" || column.id == "website") ? "" : e.target.type !== "select-one" ? requestSort(
