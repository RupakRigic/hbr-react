  ...
  const onLogin = async (e) => {
    ...
    if (error) {
      ...
      try {
        ...
        localStorage.setItem("subscription_plan", JSON.stringify(data?.data_types?.plan));
    ...
    <Fragment>
                            ...
                            >
                              ...
                              <form className=" dz-form pb-3" onSubmit={onLogin}>
                                ...
                                <div className="form-group text-left mb-5">
                                  ...
                                  <div className="form-group mb-3 text-right" style={{ marginTop: "10px" }}>
                                    <Link className="text-primary" onClick={() => setForgotModelShow(true)}>
                                      Forgot Password?
                                    </Link>
                                  </div>
                                </div>
      ...
      <Modal show={forgotModelShow} onHide={() => setForgotModelShow(true)}>
        <>
          ...
          <Modal.Footer>
            <Button variant="secondary" onClick={() => handlEmailClose()}>
              Cancel
            </Button>
