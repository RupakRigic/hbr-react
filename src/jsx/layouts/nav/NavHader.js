...
import mobilelogo from "../../../images/logo/mobile-logo.png";
...
const NavHader = () => {
  ...
  return (
    <div className="nav-header">
        <Link to={userRole === 'Admin' ? "/dashboard" : "/builderList"} className="brand-logo">
        ...
        <img src={logo} alt="" className="main-logo width-230 light-logo" />
        <img src={mobilelogo} alt="" className="logo-icon width-40 light-logo" />
      </Link>
